  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="55%">
      <el-form ref="user" :model="user" :rules="rules" label-position="left" label-width="85px">
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="重点学生姓名" prop="guardian">
              <el-input v-model="user.guardian" placeholder="请输入重点学生姓名" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="重点学生跟进记录" prop="guardianTel">
              <el-input v-model.number="user.guardianTel" placeholder="请输入重点学生跟进记录" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10">
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        // 定义表格头
        const tHeader = ['学号', '头像', '性别', '用户姓名', '身份证号', '出生日期', '手机号码', '电子邮件', '重点学生姓名', '重点学生电话', '部门']
        // 定义表格内容
