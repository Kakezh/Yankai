...
CREATE TABLE `daily_work` (
  ...
  `work_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '工作ID',
  `user_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '用户ID',
  `work_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '工作名称',
  `remake` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
  `type` int DEFAULT NULL COMMENT '工作类型（0:工作,1:会议）',
  `is_provisional` int DEFAULT NULL COMMENT '是否临时工作（0:否,1:是）',
  `is_finish` int DEFAULT NULL COMMENT '完成工作（0:未完成,1:完成）',
  `start_time` datetime DEFAULT NULL COMMENT '工作开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '工作结束时间',
  `del_flag` int DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='工作表';
...
CREATE TABLE `punishment` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `student_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '学生ID',
  `user_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '用户ID',
  `depart_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '部门ID',
  `punishment_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '处罚ID',
  `approve_type` int DEFAULT NULL COMMENT '处罚申请类型(0:处罚申请,1:撤销处罚申请)',
  `is_revoke` int DEFAULT NULL COMMENT '撤销处罚（0:正常,1:撤销）',
  `type` int DEFAULT NULL COMMENT '处罚类型（0:警告,1:严重警告,2:记过,3:留校查看,4:劝退,5:开除学籍）',
  `objection` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '撤销申请原因',
  `prove` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '证明材料',
  `approve_status` int DEFAULT NULL COMMENT '审核状态（0，待审核，1，审核中，2，通过  3，拒绝）',
  `reason` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '处罚原因',
  `counselor_opinion` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '辅导员意见',
  `audit_opinion` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '审核意见',
  `del_flag` int DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  `create_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='惩罚表';
...
CREATE TABLE `punishment_approve` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `punishment_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '处罚申请表ID',
  `counselor_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '辅导员姓名',
  `before_status` int DEFAULT NULL COMMENT '审核前状态(0，辅导员通过 1，辅导员拒绝)',
  `current_status` int DEFAULT NULL COMMENT '当前审核状态(0，待审核 1，已审核)',
  `after_status` int DEFAULT NULL COMMENT '审核后状态(0,审核通过，1，审核拒绝)',
  `remake` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '审核备注',
  `del_flag` int DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  `create_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `reward` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `student_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '学生ID',
  `type` int DEFAULT NULL COMMENT '奖励类型（0:三好学生,1:优秀学生干部,2:优秀党员,3:优秀团员）',
  `reason` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '奖励原因',
  `del_flag` int DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  `create_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='奖励表';
...
CREATE TABLE `scholarship` (
  ...
  `user_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '用户ID',
  `depart_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '部门ID',
  `level` int DEFAULT NULL COMMENT '奖学金等级（0，一等，1，二等，2，三等）',
  `ranking` int DEFAULT NULL COMMENT '综测排名',
  `prove` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '证明材料',
  `counselor_opinion` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '辅导员意见',
  `audit_opinion` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '审核意见',
  `approve_status` int DEFAULT NULL COMMENT '审核状态（0，待审核，1，审核中，2，通过  3，拒绝）',
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='奖学金表';
...
CREATE TABLE `scholarship_approve` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `scholarship_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '奖学金申请表ID',
  `counselor_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '辅导员姓名',
  `before_status` int DEFAULT NULL COMMENT '审核前状态(0，辅导员通过 1，辅导员拒绝)',
  `current_status` int DEFAULT NULL COMMENT '当前审核状态(0，待审核 1，已审核)',
  `after_status` int DEFAULT NULL COMMENT '审核后状态(0,审核通过，1，审核拒绝)',
...
CREATE TABLE `student` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `user_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '用户表ID',
  `address` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '学生家庭住址',
  `id_card` varchar(18) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '身份证号',
  `guardian` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '监护人姓名',
  `guardian_tel` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '监护人电话',
  `del_flag` int DEFAULT NULL COMMENT '删除状态 0正常 1已删除',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='学生信息表';
...
CREATE TABLE `sys_depart` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'ID',
  `parent_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '父机构ID',
  ...
  `org_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '机构类型 1一级部门 2子部门',
  `description` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '描述',
  `remake` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
  `status` int DEFAULT NULL COMMENT '状态（1启用，0不启用）',
  `del_flag` int DEFAULT NULL COMMENT '删除状态（0，正常，1已删除）',
  `create_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
...
CREATE TABLE `sys_permission` (
  ...
  `component` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '前端组件',
  ...
  `is_route` int NOT NULL DEFAULT '1' COMMENT '是否路由菜单: 0:不是  1:是（默认值1）',
...
CREATE TABLE `sys_role_permission` (
  ...
  `role_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '角色id',
  `permission_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '权限id',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_user` (
  ...
  `error_num` int NOT NULL DEFAULT '0' COMMENT '登录失败次数',
  `depart_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '所属部门',
  `depart_ids` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci COMMENT '负责部门',
  `role_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '所属角色',
  ...
  `user_identity` int DEFAULT NULL COMMENT '身份（1学生 2辅导员 3管理员 4其他）',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1463444095002333185', 'admin', '管理员', 'G4Njnwj2GGc=', 'iKeM3sXB', '0', '1462722550017568769', '1462722550017568769,1466718101755179009,1466728711498805250,1467485964803780610,1475053043220279297,1475075670336864257', '1462394142624624642', '0', '1258083176@qq.com', '15328062122', '1', '3', '2001-03-09 00:00:00', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', '0', 'admin', '2021-11-24 17:47:16', 'admin', '2021-12-26 20:35:48');
INSERT INTO `sys_user` VALUES ('1467111457366851586', 'test', '测试用户', 'U/BLpOwgNzY=', 'kOuPR7Ve', '0', '1466718101755179009', '1462722550017568769,1466718101755179009', '1462394142624624642', '0', null, null, '1', '3', '2017-09-12 00:00:00', null, '0', 'admin', '2021-12-04 20:40:04', 'admin', '2021-12-07 19:05:44');
INSERT INTO `sys_user` VALUES ('1467118284183814146', 'test2', '测试用户2', 'A7brldH4qyM=', '6hwuGaqX', '0', '1466718101755179009', '1466718101755179009', '1462394142624624642', '0', null, null, '1', '3', '2021-12-01 00:00:00', null, '1', 'admin', '2021-12-04 21:07:11', null, null);
INSERT INTO `sys_user` VALUES ('1467493626018803714', '01', '张三', 'ktfK9/k3Kqc=', 'YFVFWxnY', '0', '1467485964803780610', '', '1467463966245531650', '1', '14523698@ex.com', '14785236901', '1', '1', '2003-12-17 00:00:00', 'https://edufile-guli.oss-cn-beijing.aliyuncs.com/2021/12/26/bc636bb4abfe4921b084f891596c33d6.jpg', '0', 'admin', '2021-12-05 21:58:40', 'admin', '2021-12-27 15:56:15');
INSERT INTO `sys_user` VALUES ('1468153060726530050', '02', '王五', 'MuwOfy6uTvk=', 'kQ22CuyT', '0', '1467485964803780610', '', '1467463966245531650', '1', null, null, '1', '1', '2008-12-01 00:00:00', null, '0', 'admin', '2021-12-07 17:39:01', 'admin', '2021-12-07 18:31:32');
INSERT INTO `sys_user` VALUES ('1468162010343661569', '03', '赵六', 'D86Gj29zDqY=', 'apTYcYNR', '0', '1467485964803780610', '', '1467463966245531650', '1', null, null, '1', '1', '2017-12-12 00:00:00', null, '0', 'admin', '2021-12-07 18:14:35', null, null);
INSERT INTO `sys_user` VALUES ('1468165489778876418', '04', '韩梅', 'iPSB7jz+Dpc=', 'pgpyqFLZ', '0', '1467485964803780610', '', '1467463966245531650', '2', null, null, '1', '1', '2016-12-21 00:00:00', null, '0', 'admin', '2021-12-07 18:28:25', null, null);
INSERT INTO `sys_user` VALUES ('1468176827158749185', '06', '测试学生', '2Du6rWesMRI=', 'NbCr1uYy', '0', '1475075563755405314', '', '1462394142624624642', '1', null, null, '2', '1', '2002-12-04 00:00:00', null, '0', 'admin', '2021-12-07 19:13:28', 'admin', '2022-04-26 16:20:58');
INSERT INTO `sys_user` VALUES ('1468177835876278273', '05', '赵敏', 'f0tD4D9I4+E=', 'A0YAsBWR', '0', '1467485964803780610', '', '1467463966245531650', '1', null, null, '1', '1', null, null, '0', 'admin', '2021-12-07 19:17:28', null, null);
INSERT INTO `sys_user` VALUES ('1470332784399642625', 'fdy', '张伟', 'z2IV0iEf+1k=', 'z64mmjby', '0', '1466728711498805250', '1466728711498805250,1467485964803780610,1475053043220279297,1475075670336864257', '1467464182604509185', '1', null, null, '1', '2', null, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', '0', 'admin', '2021-12-13 18:00:28', 'admin', '2021-12-26 20:37:51');
INSERT INTO `sys_user` VALUES ('1470403569957060610', '08', 'lrc', 'yQr/O8REHjk=', 'iOVGoFCC', '0', '1467485964803780610', '', '1467463966245531650', '1', null, null, '1', '1', null, 'user/93a3ab65195d82875c6ae06e8e0910cb6131d3fb_raw_1639406478658.jpg', '1', 'admin', '2021-12-13 22:41:45', 'admin', '2021-12-13 22:42:08');
INSERT INTO `sys_user` VALUES ('1470660553264394241', '09', '王富贵', 'fgQgSKsoWpE=', 'iPu0QaEX', '0', '1462722550017568769', '', '1465970449476268033', '1', null, null, '1', '4', null, null, '0', 'admin', '2021-12-14 15:42:54', null, null);
INSERT INTO `sys_user` VALUES ('1470688597362429953', '07', '学生', 'mB9xlB0MUCk=', 'VQcSLt9k', '0', '1475053043220279297', '', '1467463966245531650', '1', null, null, '1', '1', null, null, '0', 'admin', '2021-12-14 17:34:20', 'admin', '2021-12-31 15:29:58');
INSERT INTO `sys_user` VALUES ('1476817727229284353', '10', 'test1', 'SHrftmTiV88=', 'CnttTuqk', '0', '1475053043220279297', '', '1465970449476268033', '0', null, null, '1', '4', null, null, '0', 'admin', '2021-12-31 15:29:18', 'admin', '2022-04-26 16:52:20');
INSERT INTO `sys_user` VALUES ('1734152791024234498', 'admin1', null, 'nap9sOLRUio=', 'hC0cYSZi', '0', null, null, null, '0', null, null, '1', '2', null, null, '0', 'admin', '2023-12-11 18:06:59', null, null);
...
CREATE TABLE `sys_user_depart` (
  `id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'id',
  `user_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '用户id',
  `dep_id` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '部门id',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `work` (
  ...
  `remake` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
  `type` int DEFAULT NULL COMMENT '工作类型（0:工作,1:会议）',
  `start_time` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '工作开始时间',
  `del_flag` int DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  `create_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='日常工作表';
